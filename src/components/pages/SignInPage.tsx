...
const DEMO_ACCOUNTS = [
  ...
  { label: 'Sr. Admin',    icon: '🔐',  email: 'admin@digitalmanufacturing.academy',          password: 'Dmamfg.2026' },
  { label: 'Director',     icon: '🏫',  email: 'superadmin@digitalmanufacturing.academy',     password: 'Dmamfg.2026' },
